...
ApplicationWindow {
    ...
    // Theme.dark and Theme.activeFontFamily are set from C++ (app_main.cpp)
    // via direct QMetaObject::invokeMethod calls — NO QML bindings or Connections
    // This completely eliminates all binding loops.
