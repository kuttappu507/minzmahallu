...
ApplicationWindow {
    ...
    Item {
        ...
        Behavior on sidebarWidth { NumberAnimation { duration: Theme.animSlow; easing.type: Easing.OutCubic } }
            ...
            Rectangle {
                ...
                Column {
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            Column {
                                ...
                                Text { text: "Minz Mahallu"; font.family: Theme.fontFamily; font.pixelSize: 10; font.weight: Font.DemiBold; color: Theme.sidebarSubTitle }
                            }
                        }
                        Rectangle {
                    ...
                    Rectangle {
                        ...
                        x: parent.width - 12; y: parent.height / 2 - 24; z: 100
                    ...
                    Text {
                        text: "OVERVIEW"; font.family: Theme.fontFamily; font.pixelSize: 9; font.weight: Font.Bold
                    ...
                    ListView {
                        ...
                        delegate: Item {
                            ...
                            Rectangle {
                                ...
                                Rectangle { x: -10; y: (34 - 20) / 2; width: 4; height: 20; radius: 4; color: "#f2c14e"; visible: ListView.isCurrentItem }
                            }
                            Row {
                                x: 13; y: 0; height: 34; spacing: 12
                                Item {
                                    width: 17; height: 17; y: (34 - 17) / 2
                    ...
                    Item {
                        ...
                        Rectangle { x: 10; y: 9; width: profileRow.width + 8; height: profileRow.height + 8; radius: 9; color: Qt.rgba(255,255,255, profileHover.containsMouse ? 0.06 : 0); Behavior on color { ColorAnimation { duration: Theme.animFast } } z: -1; visible: !mainApp.sidebarCollapsed }
                        ...
                        Row {
                            ...
                            Rectangle { width: 36; height: 36; radius: 9; color: "#f2c14e"; border.width: 2; border.color: "#b98317"; Text { anchors.centerIn: parent; text: AuthController.initials; font.family: Theme.fontFamily; font.pixelSize: 13; font.weight: Font.DemiBold; color: "#4a3606" } }
                            Column { spacing: 0; Text { text: AuthController.fullName; font.family: Theme.fontFamily; font.pixelSize: 13; font.weight: Font.DemiBold; color: "#ffffff" }; Text { text: AuthController.role; font.family: Theme.fontFamily; font.pixelSize: 11; color: Theme.sidebarSubTitle } }
                        }
                        Rectangle { anchors.centerIn: parent; visible: mainApp.sidebarCollapsed; width: 36; height: 36; radius: 9; color: "#f2c14e"; border.width: 2; border.color: "#b98317"; Text { anchors.centerIn: parent; text: AuthController.initials; font.family: Theme.fontFamily; font.pixelSize: 13; font.weight: Font.DemiBold; color: "#4a3606" } }
                    }
                }
            }
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Text { text: "MINZ MAHALLU /"; font.family: Theme.fontFamily; font.pixelSize: 11; font.weight: Font.Bold; color: Theme.textTertiary; anchors.verticalCenter: parent.verticalCenter }
                        Text { text: navList.model.get(navList.currentIndex) ? I18NController.tr(navList.model.get(navList.currentIndex).key) : I18NController.tr("nav_dashboard"); font.family: Theme.fontFamily; font.pixelSize: 16; font.weight: Font.DemiBold; color: Theme.textPrimary; anchors.verticalCenter: parent.verticalCenter }
                    }
                    Row {
                        ...
                        Rectangle {
                            ...
                            MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: { I18NController.toggleLanguage(); SettingsController.language = I18NController.currentLanguage; SettingsController.save() } }
                        ...
                        Rectangle {
                            ...
                            MouseArea { anchors.fill: parent; cursorShape: Qt.PointingHandCursor; onClicked: { SettingsController.theme = SettingsController.theme === "light" ? "dark" : "light"; SettingsController.save() } }
                            Item { width: 16; height: 16; anchors.centerIn: parent; Image { id: themeIcon; source: "qrc:/icons/svg/" + (SettingsController.theme === "dark" ? "sun" : "moon") + ".svg"; sourceSize: Qt.size(16, 16); anchors.fill: parent; fillMode: Image.Pad; visible: false }; MultiEffect { anchors.fill: parent; source: themeIcon; colorizationColor: Theme.textTertiary; colorization: 1.0 } }
                        }
                        Rectangle {
                            width: 250; height: 38; radius: 9; color: Theme.surfaceSubtle; border.width: 1
                            ...
                            Item { width: 16; height: 16; anchors.left: parent.left; anchors.leftMargin: 10; anchors.verticalCenter: parent.verticalCenter; Image { id: shellSearchIcon; source: "qrc:/icons/svg/search.svg"; sourceSize: Qt.size(16,16); anchors.fill: parent; visible: false }; MultiEffect { anchors.fill: parent; source: shellSearchIcon; colorizationColor: searchInput.activeFocus ? Theme.primary : Theme.textTertiary; colorization: 1.0 } }
                            TextField { id: searchInput; anchors.left: parent.left; anchors.leftMargin: 32; anchors.right: parent.right; anchors.rightMargin: 10; anchors.verticalCenter: parent.verticalCenter; placeholderText: "Search records..."; placeholderTextColor: Theme.textTertiary; font.family: Theme.fontFamily; font.pixelSize: 13; color: Theme.textPrimary; background: Item {}; verticalAlignment: Text.AlignVCenter }
                        }
                    }
                }
