...
// ============================================================================
// DashboardV3 — Faithful HTML/CSS → QML visual port
//
// Every color, size, spacing, radius is mechanically translated from:
// Pasted Content_1785520850664.txt (the canonical HTML reference)
//
// Layout structure mirrors HTML exactly:
//   ApplicationWindow
//   RowLayout (sidebar + main)
//     Sidebar (260px, green gradient, gold accents)
//     ColumnLayout
//       TopBar (58px, white, breadcrumb + search)
//       ScrollView
//         ColumnLayout (content)
//           vhead (greeting + chips)
//           qa-row (5 quick action buttons)
//           stat-grid (10 stat cards, 5 columns)
//           chart-grid (2 chart cards)
//           ev-row (2 event cards)
// ============================================================================
