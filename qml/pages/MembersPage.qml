        ...
        onAccepted: {
            if (_memberId > 0) {
                ...
                if (!result.success) {
                    ...
                    toast.show("Member deleted", Theme.primary)
                }
            }
        }
    }
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Column {
                ...
                spacing: 2
                Text {
                    text: { var _l = I18NController.currentLanguage; return I18NController.tr("nav_members") }
                    font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeXl; font.weight: Font.DemiBold; color: Theme.textPrimary
                }
                Text {
                    text: { var _l = I18NController.currentLanguage; return I18NController.tr("member_subtitle") }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Item {
                    ...
                    MultiEffect { anchors.fill: parent; source: memSearchIcon; colorizationColor: searchField.activeFocus ? Theme.primary : Theme.textTertiary; colorization: 1.0; Behavior on colorizationColor { ColorAnimation { duration: 120 } } }
                }
                TextField {
                    id: searchField
            ...
            Text {
                text: { var _l = I18NController.currentLanguage; return I18NController.tr("ui_records") + ": " + memberModel.rowCount + " / " + memberModel.totalCount }
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Text { text: { var _l = I18NController.currentLanguage; return I18NController.tr("member_code") } width: 100; height: 40; verticalAlignment: Text.AlignVCenter; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeXs; font.weight: Font.Medium; color: Theme.textTertiary }
                        Text { text: { var _l = I18NController.currentLanguage; return I18NController.tr("member_name") } width: 180; height: 40; verticalAlignment: Text.AlignVCenter; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeXs; font.weight: Font.Medium; color: Theme.textTertiary }
                        ...
                        Text { text: "RELATION"; width: 100; height: 40; verticalAlignment: Text.AlignVCenter; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeXs; font.weight: Font.Medium; color: Theme.textTertiary }
                        Text { text: "MOBILE"; width: 120; height: 40; verticalAlignment: Text.AlignVCenter; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeXs; font.weight: Font.Medium; color: Theme.textTertiary }
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        Row {
                            x: 16; width: parent.width - 32; spacing: 0
                            Text { text: model.memberCode; width: 100; height: 44; verticalAlignment: Text.AlignVCenter; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeSm; font.weight: Font.DemiBold; color: Theme.textPrimary; elide: Text.ElideRight }
                            Text { text: model.name; width: 180; height: 44; verticalAlignment: Text.AlignVCenter; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeSm; font.weight: Font.Normal; color: Theme.textPrimary; elide: Text.ElideRight }
                            Text { text: (model.familyNumber || "") + " " + (model.houseName || ""); width: 150; height: 44; verticalAlignment: Text.AlignVCenter; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeSm; font.weight: Font.Normal; color: Theme.textSecondary; elide: Text.ElideRight }
                            Text { text: model.gender || "—"; width: 80; height: 44; verticalAlignment: Text.AlignVCenter; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeSm; font.weight: Font.Normal; color: Theme.textSecondary }
                            ...
                            Text { text: model.relationship || "—"; width: 100; height: 44; verticalAlignment: Text.AlignVCenter; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeSm; font.weight: Font.Normal; color: Theme.textSecondary }
                            Text { text: model.mobile; width: 120; height: 44; verticalAlignment: Text.AlignVCenter; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeSm; font.weight: Font.Normal; color: Theme.textSecondary }
                            ...
                            Row {
                                ...
                                TableActionButton {
                                    iconSource: "qrc:/icons/svg/trash.svg"; variantColor: Theme.danger
                                    anchors.verticalCenter: parent.verticalCenter
                                    onClicked: {
                                ...
                                TableActionButton {
                                    iconSource: "qrc:/icons/svg/edit.svg"; variantColor: Theme.primary
                                    anchors.verticalCenter: parent.verticalCenter
                                    onClicked: { editDialog.memberId = model.id; editDialog.readOnly = false; editDialog.show() }
                                }
                                TableActionButton {
                                    iconSource: "qrc:/icons/svg/search.svg"; variantColor: Theme.blue
                                    anchors.verticalCenter: parent.verticalCenter
                ...
                Item {
                    ...
                    Column {
                        ...
                        Text { text: "No members found"; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeMd; font.weight: Font.DemiBold; color: Theme.textPrimary; anchors.horizontalCenter: parent.horizontalCenter }
                        Text { text: "Click 'Add Member' to create your first member record"; font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeXs; font.weight: Font.Normal; color: Theme.textTertiary; anchors.horizontalCenter: parent.horizontalCenter }
                    }
                }
