            ...
            ColumnLayout {
                ...
                ScrollView {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout { Layout.fillWidth: true; spacing: 16
                            ColumnLayout { Layout.fillWidth: true; spacing: 4
                                Text { text: "Category *"; font.family: "Poppins"; font.pixelSize: 11; font.weight: Font.Medium; color: dialog._errorField === "categoryId" ? "#e11d48" : "#7e968a" }
                                Rectangle { Layout.fillWidth: true; height: 38; radius: 9; color: "#f2faf4"; border.width: 1; border.color: dialog._errorField === "categoryId" ? "#e11d48" : (catMA.containsMouse ? "#b2cfbd" : "#d2e5d8"); Behavior on border.color { ColorAnimation { duration: 120 } }
                                    ...
                                    Text { anchors.left: parent.left; anchors.leftMargin: 10; anchors.verticalCenter: parent.verticalCenter
                                        ...
                                        font.family: "Poppins"; font.pixelSize: 13; color: dialog._categoryId !== "" ? "#12241b" : "#7e968a" }
                                    Popup { id: catPopup; y: parent.height + 4; width: parent.width; implicitHeight: 280; padding: 4; background: Rectangle { color: "#ffffff"; border.width: 1; border.color: "#d2e5d8"; radius: 9 }
                                        ListView { anchors.fill: parent; clip: true; spacing: 2; model: dialog._categories
                                            delegate: ItemDelegate { width: parent.width; height: 34; padding: 0
                                                contentItem: Text { text: modelData.name; font.family: "Poppins"; font.pixelSize: 13; color: "#12241b"; anchors.left: parent.left; anchors.leftMargin: 8; anchors.verticalCenter: parent.verticalCenter }
                        ...
                        ColumnLayout { Layout.fillWidth: true; spacing: 4
                            Text { text: "DONOR ADDRESS"; font.family: "Poppins"; font.pixelSize: 11; font.weight: Font.Medium; color: "#7e968a" }
                            TextArea { Layout.fillWidth: true; Layout.preferredHeight: 56; text: dialog._donorAddress; readOnly: dialog.readOnly; font.family: "Poppins"; font.pixelSize: 13; color: "#12241b"; placeholderText: "Donor address (optional)..."; placeholderTextColor: "#7e968a"; selectByMouse: true; wrapMode: TextArea.Wrap
