        ...
        Rectangle {
            ...
            Column { anchors.centerIn: parent; spacing: 16
                ...
                Column { spacing: 4; anchors.horizontalCenter: parent.horizontalCenter
                    Text { text: "Token Distribution"; font.family: Theme.activeFontFamily; font.pixelSize: 16; font.weight: Font.DemiBold; color: Theme.textPrimary; anchors.horizontalCenter: parent.horizontalCenter }
                    Text { text: "Token events with per-family unique codes"; font.family: Theme.activeFontFamily; font.pixelSize: 12; color: Theme.textTertiary; anchors.horizontalCenter: parent.horizontalCenter }
                    Text { text: "Requires database schema migration (token tables missing)"; font.family: Theme.activeFontFamily; font.pixelSize: 11; color: Theme.danger; anchors.horizontalCenter: parent.horizontalCenter } }
            }
        }
    }
}
