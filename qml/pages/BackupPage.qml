    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Column { Layout.fillWidth: true; spacing: 2
                ...
                Text { text: "Database backup and restore (" + backups.length + " backups)"; font.family: "Poppins"; font.pixelSize: 12; color: "#4f6b5c" } }
        }
            ...
            ColumnLayout { anchors.fill: parent; spacing: 0
                Rectangle { Layout.fillWidth: true; Layout.preferredHeight: 40; color: "#f2faf4"
                    ...
                    Row { x: 16; width: parent.width - 32; spacing: 0
                        Text { text: "FILE"; width: 200; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                        Text { text: "CREATED"; width: 160; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                        Text { text: "SIZE"; width: 100; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                        Text { text: "PATH"; width: parent.width - 200 - 160 - 100 - 120; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                        Text { text: "ACTIONS"; width: 120; height: 40; verticalAlignment: Text.AlignVCenter; horizontalAlignment: Text.AlignHCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" } } }
                ListView { id: table; Layout.fillWidth: true; Layout.fillHeight: true; clip: true; spacing: 0; model: page.backups
                    delegate: Rectangle { width: table.width; height: 44; color: rowMA.containsMouse ? "#f2faf4" : (index % 2 === 0 ? "#ffffff" : "#fafdfa")
                        ...
                        Row { x: 16; width: parent.width - 32; spacing: 0
                            Text { text: modelData.fileName; width: 200; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; font.weight: Font.DemiBold; color: "#12241b"; elide: Text.ElideRight }
                            Text { text: modelData.created; width: 160; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; color: "#4f6b5c" }
                            Text { text: modelData.sizeDisplay; width: 100; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; color: "#4f6b5c" }
                            Text { text: modelData.fullPath; width: parent.width - 200 - 160 - 100 - 120; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 11; color: "#7e968a"; elide: Text.ElideRight }
                ...
                Item { Layout.fillWidth: true; Layout.fillHeight: true; visible: page.backups.length === 0
                    Column { anchors.centerIn: parent; spacing: 8
                        Text { text: "No backups found"; font.family: "Poppins"; font.pixelSize: 14; font.weight: Font.DemiBold; color: "#12241b"; anchors.horizontalCenter: parent.horizontalCenter }
                        Text { text: "Click 'Create Backup' to create your first backup"; font.family: "Poppins"; font.pixelSize: 11; color: "#7e968a"; anchors.horizontalCenter: parent.horizontalCenter } } }
            }
        }
    }
}
