            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        Text { text: { var _l = I18NController.currentLanguage; return I18NController.tr("ui_page") + " " + familyModel.currentPage + " " + I18NController.tr("page_of") + " " + familyModel.totalPages } font.family: Theme.activeFontFamily; font.pixelSize: Theme.fontSizeXs; color: Theme.textTertiary; Layout.alignment: Qt.AlignVCenter }
