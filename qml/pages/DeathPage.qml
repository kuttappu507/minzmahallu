    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Column { Layout.fillWidth: true; spacing: 2
                Text { text: "Death Register"; font.family: "Poppins"; font.pixelSize: 21; font.weight: Font.DemiBold; color: "#12241b" }
                Text { text: "Death and burial records"; font.family: "Poppins"; font.pixelSize: 12; color: "#4f6b5c" } }
        }
        ...
        RowLayout {
            ...
            Text { text: "Showing " + deathModel.rowCount + " of " + deathModel.totalCount; font.family: "Poppins"; font.pixelSize: 11; color: "#7e968a"; Layout.alignment: Qt.AlignVCenter }
        }
            ...
            ColumnLayout { anchors.fill: parent; spacing: 0
                Rectangle { Layout.fillWidth: true; Layout.preferredHeight: 40; color: "#f2faf4"
                    ...
                    Row { x: 16; width: parent.width - 32; spacing: 0
                        ...
                        Text { text: "DECEASED"; width: 180; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                        Text { text: "FATHER"; width: 160; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                        ...
                        Text { text: "DATE OF DEATH"; width: 120; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                        Text { text: "BURIAL DATE"; width: 120; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                        Text { text: "FAMILY"; width: 120; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                ...
                ListView { id: table; Layout.fillWidth: true; Layout.fillHeight: true; clip: true; spacing: 0; model: deathModel
                    delegate: Rectangle { width: table.width; height: 44; color: rowMA.containsMouse ? "#f2faf4" : (index % 2 === 0 ? "#ffffff" : "#fafdfa")
                        ...
                        Row { x: 16; width: parent.width - 32; spacing: 0
                            Text { text: model.deathNumber; width: 120; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; font.weight: Font.DemiBold; color: "#12241b"; elide: Text.ElideRight }
                            Text { text: model.deceasedName; width: 180; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; color: "#12241b"; elide: Text.ElideRight }
                            Text { text: model.fatherName || "—"; width: 160; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; color: "#4f6b5c"; elide: Text.ElideRight }
                            Text { text: model.gender || "—"; width: 80; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; color: "#4f6b5c" }
                            ...
                            Text { text: model.dateOfDeath || "—"; width: 120; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; color: "#4f6b5c" }
                            Text { text: model.burialDate || "—"; width: 120; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; color: "#4f6b5c" }
                            Text { text: model.familyNumber || "—"; width: 120; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; color: "#4f6b5c" }
                ...
                Item { Layout.fillWidth: true; Layout.fillHeight: true; visible: deathModel.rowCount === 0
                    Column { anchors.centerIn: parent; spacing: 8
                        Text { text: "No death records found"; font.family: "Poppins"; font.pixelSize: 14; font.weight: Font.DemiBold; color: "#12241b"; anchors.horizontalCenter: parent.horizontalCenter }
                ...
                Rectangle { Layout.fillWidth: true; Layout.preferredHeight: 44; color: "#f2faf4"
                    ...
                    RowLayout { anchors.fill: parent; anchors.leftMargin: 16; anchors.rightMargin: 16; spacing: 8
                        Text { text: "Page " + deathModel.currentPage + " of " + deathModel.totalPages; font.family: "Poppins"; font.pixelSize: 11; color: "#7e968a"; Layout.alignment: Qt.AlignVCenter }
