    ...
    ConfirmDialog {
        ...
        onAccepted: {
            if (_id > 0) {
                ...
                toast.show(r.success ? "Request deleted" : (r.error || "Delete failed"), r.success ? Theme.primary : Theme.danger)
            }
        }
    }
            ...
            ColumnLayout { anchors.fill: parent; spacing: 0
                    ...
                    delegate: Rectangle { width: table.width; height: 44; color: rowMA.containsMouse ? Theme.surfaceHover : (index % 2 === 0 ? Theme.surface : Theme.surfaceSubtle)
                        ...
                        Row { x: 16; width: parent.width - 32; spacing: 0
                            ...
                            Row { width: 80; height: 44; spacing: 4; layoutDirection: Qt.RightToLeft
                                TableActionButton { iconSource: "qrc:/icons/svg/trash.svg"; variantColor: Theme.danger; anchors.verticalCenter: parent.verticalCenter; onClicked: { deleteDialog._id = model.id; deleteDialog.warningText = "Welfare request " + model.requestNumber + " will be permanently deleted."; deleteDialog.visible = true } }
                                TableActionButton { iconSource: "qrc:/icons/svg/edit.svg"; variantColor: Theme.primary; anchors.verticalCenter: parent.verticalCenter; onClicked: { editDialog.requestId = model.id; editDialog.readOnly = false; editDialog.show() } }
                                TableActionButton { iconSource: "qrc:/icons/svg/search.svg"; variantColor: Theme.blue; anchors.verticalCenter: parent.verticalCenter; onClicked: { editDialog.requestId = model.id; editDialog.readOnly = true; editDialog.show() } } } }
                ...
                Rectangle { Layout.fillWidth: true; Layout.preferredHeight: 44; color: Theme.surfaceHover
                    ...
                    RowLayout { anchors.fill: parent; anchors.leftMargin: 16; anchors.rightMargin: 16; spacing: 8
                        ...
                        Rectangle { width: 28; height: 28; radius: 6; color: nextMA.containsMouse ? Theme.surface : "transparent"; border.width: 1; border.color: nextMA.containsMouse ? Theme.borderHover : Theme.border; Layout.alignment: Qt.AlignVCenter; opacity: welfareModel.currentPage < welfareModel.totalPages ? 1 : 0.4
