                ...
                ScrollView {
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout { Layout.fillWidth: true; spacing: 4
                            Text { text: "RECEIPT NUMBER"; font.family: "Poppins"; font.pixelSize: 11; font.weight: Font.Medium; color: "#7e968a" }
                            Rectangle { Layout.fillWidth: true; height: 38; radius: 9; color: "#f2faf4"; border.width: 1; border.color: "#d2e5d8"
                                Text { anchors.left: parent.left; anchors.leftMargin: 10; anchors.verticalCenter: parent.verticalCenter; text: dialog._receiptNumber || "Auto-generated on save"; font.family: "Poppins"; font.pixelSize: 13; color: dialog._receiptNumber ? "#12241b" : "#7e968a" } } }

                        // Family selector (custom popup)
                        ColumnLayout { Layout.fillWidth: true; spacing: 4
                            Text { text: "Family *"; font.family: "Poppins"; font.pixelSize: 11; font.weight: Font.Medium; color: dialog._errorField === "familyId" ? "#e11d48" : "#7e968a" }
                            Rectangle { Layout.fillWidth: true; height: 38; radius: 9; color: "#f2faf4"; border.width: 1; border.color: dialog._errorField === "familyId" ? "#e11d48" : (familyMA.containsMouse ? "#b2cfbd" : "#d2e5d8"); Behavior on border.color { ColorAnimation { duration: 120 } }
                        ...
                        ColumnLayout { Layout.fillWidth: true; spacing: 4; enabled: dialog._familyId !== ""
                            ...
                            Rectangle { Layout.fillWidth: true; height: 38; radius: 9; color: "#f2faf4"; border.width: 1; border.color: memberMA.containsMouse ? "#b2cfbd" : "#d2e5d8"; Behavior on border.color { ColorAnimation { duration: 120 } } opacity: enabled ? 1 : 0.5
                                ...
                                Text { anchors.left: parent.left; anchors.leftMargin: 10; anchors.verticalCenter: parent.verticalCenter
                                    ...
                                    font.family: "Poppins"; font.pixelSize: 13; color: dialog._memberId !== "" ? "#12241b" : "#7e968a" }
                                Popup { id: memberPopup; y: parent.height + 4; width: parent.width; implicitHeight: 280; padding: 4; background: Rectangle { color: "#ffffff"; border.width: 1; border.color: "#d2e5d8"; radius: 9 }
                                    ListView { anchors.fill: parent; clip: true; spacing: 2; model: dialog._members
                                        delegate: ItemDelegate { width: parent.width; height: 34; padding: 0
                                            contentItem: Text { text: modelData.name + " (" + modelData.relationship + ")"; font.family: "Poppins"; font.pixelSize: 13; color: "#12241b"; anchors.left: parent.left; anchors.leftMargin: 8; anchors.verticalCenter: parent.verticalCenter }
                                            background: Rectangle { color: highlighted ? "#ecfdf5" : "transparent"; radius: 4 }
                                            onClicked: { dialog._memberId = modelData.id.toString(); memberPopup.visible = false } } } } } }

                        // Plan selector
                        ColumnLayout { Layout.fillWidth: true; spacing: 4
                            Text { text: "Plan *"; font.family: "Poppins"; font.pixelSize: 11; font.weight: Font.Medium; color: dialog._errorField === "planId" ? "#e11d48" : "#7e968a" }
                            Rectangle { Layout.fillWidth: true; height: 38; radius: 9; color: "#f2faf4"; border.width: 1; border.color: dialog._errorField === "planId" ? "#e11d48" : (planMA.containsMouse ? "#b2cfbd" : "#d2e5d8"); Behavior on border.color { ColorAnimation { duration: 120 } }
                                ...
                                Text { anchors.left: parent.left; anchors.leftMargin: 10; anchors.verticalCenter: parent.verticalCenter
                                    ...
                                    font.family: "Poppins"; font.pixelSize: 13; color: dialog._planId !== "" ? "#12241b" : "#7e968a" }
                                Popup { id: planPopup; y: parent.height + 4; width: parent.width; implicitHeight: 280; padding: 4; background: Rectangle { color: "#ffffff"; border.width: 1; border.color: "#d2e5d8"; radius: 9 }
                                    ListView { anchors.fill: parent; clip: true; spacing: 2; model: dialog._plans
                                        delegate: ItemDelegate { width: parent.width; height: 34; padding: 0
                                            contentItem: Text { text: modelData.name + " (₹" + modelData.defaultAmount + ", " + modelData.frequency + ")"; font.family: "Poppins"; font.pixelSize: 13; color: "#12241b"; anchors.left: parent.left; anchors.leftMargin: 8; anchors.verticalCenter: parent.verticalCenter }
                                            background: Rectangle { color: highlighted ? "#ecfdf5" : "transparent"; radius: 4 }
