    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Column {
                ...
                Text { text: "Accounting"; font.family: "Poppins"; font.pixelSize: 21; font.weight: Font.DemiBold; color: "#12241b" }
                Text { text: "Manage ledger accounts and transactions"; font.family: "Poppins"; font.pixelSize: 12; font.weight: Font.Normal; color: "#4f6b5c" }
            }
            AppButton {
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Text { text: "ACCOUNT"; width: 200; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                        Text { text: "TYPE"; width: 90; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                        Text { text: "AMOUNT"; width: 110; height: 40; verticalAlignment: Text.AlignVCenter; horizontalAlignment: Text.AlignRight; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                        ...
                        Text { text: "DESCRIPTION"; width: parent.width - 110 - 200 - 90 - 110 - 100 - 80; height: 40; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 10; font.weight: Font.Medium; color: "#7e968a" }
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        Row {
                            x: 16; width: parent.width - 32; spacing: 0
                            Text { text: model.txnDate || "—"; width: 110; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; font.weight: Font.Normal; color: "#4f6b5c" }
                            Text { text: (model.accountCode || "") + " - " + (model.accountName || "—"); width: 200; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; font.weight: Font.Normal; color: "#12241b"; elide: Text.ElideRight }
                            ...
                            Text { text: (model.type === "Expense" ? "-" : "+") + "₹" + model.amount.toFixed(0); width: 110; height: 44; verticalAlignment: Text.AlignVCenter; horizontalAlignment: Text.AlignRight; font.family: "Poppins"; font.pixelSize: 12; font.weight: Font.DemiBold; color: model.type === "Income" ? "#059669" : "#e11d48" }
                            ...
                            Text { text: model.description || "—"; width: parent.width - 110 - 200 - 90 - 110 - 100 - 80; height: 44; verticalAlignment: Text.AlignVCenter; font.family: "Poppins"; font.pixelSize: 12; font.weight: Font.Normal; color: "#4f6b5c"; elide: Text.ElideRight }
                            Row {
                ...
                Item {
                    ...
                    Column {
                        ...
                        Text { text: "No transactions found"; font.family: "Poppins"; font.pixelSize: 14; font.weight: Font.DemiBold; color: "#12241b"; anchors.horizontalCenter: parent.horizontalCenter }
                        Text { text: "Click 'Add Transaction' to create your first record"; font.family: "Poppins"; font.pixelSize: 11; font.weight: Font.Normal; color: "#7e968a"; anchors.horizontalCenter: parent.horizontalCenter }
                    }
                }
                ...
                Rectangle {
                    ...
                    RowLayout {
                        ...
                        Text { text: "Page " + transactionModel.currentPage + " of " + transactionModel.totalPages; font.family: "Poppins"; font.pixelSize: 11; color: "#7e968a"; Layout.alignment: Qt.AlignVCenter }
                        Item { Layout.fillWidth: true }
